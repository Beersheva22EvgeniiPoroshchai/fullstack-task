...
import AddEmployee from "./components/pages/AddAdvert";
...
const App: React.FC = () => {
  ...
  <Routes>
    <Route path="/" element={<NavigatorDispatcher routes={routes}/>}>
        ...
        <Route path="/adbycategory" element={<AdvertsByCategory/>}/>
        <Route path="/adbyprice" element={<AdvertsByPrice/>}/>
        <Route path="/addad" element={<AddAdvert/>}/>
